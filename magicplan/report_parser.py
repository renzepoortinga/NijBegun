...
LABEL_TO_KEY = {
    ...
    "gevel - bcrg-code": "gevel_bcrg_code", "gevel - bcrg code": "gevel_bcrg_code",
    "gevel - bcrg-isolatiedikte (mm)": "isolatie_mm",
    ...
    "vloer - bcrg-code": "vloer_bcrg_code", "vloer - bcrg code": "vloer_bcrg_code",
    "vloer - bcrg-isolatiedikte (mm)": "vloer_isolatie_mm",
    ...
    "dak - bcrg-code": "dak_bcrg_code", "dak - bcrg code": "dak_bcrg_code",
    "dak - bcrg-isolatiedikte (mm)": "dak_isolatie_mm",
    "dak - isolatiedikte (mm)": "dak_isolatie_mm",
