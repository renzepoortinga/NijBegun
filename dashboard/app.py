...
<span class=muted>netto warmtebehoefte {{h.behoefte}} vs Standaard {{h.standaard if h.standaard is not none else '—'}} kWh/m²·jr
...
<span class=muted>netto warmtebehoefte {{na.behoefte}} vs Standaard {{na.standaard}} kWh/m²·jr{% if na.marge is not none %} · marge {{na.marge}}{% endif %}</span></div></div>
