...
- 2026-08-21 (Codex Reviewer/Manager): eerste review FAIL op dashboardpaden/projectzip en
  prefix-traversal; beide blockers in `f7de131` gerepareerd. Herreview PASS: CURRENT en legacy,
  manifestfalen, traversal en concurrency aantoonbaar gedekt. Taak naar `done` verplaatst.
